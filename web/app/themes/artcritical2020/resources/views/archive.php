...
if($wp_query->query_vars['category_name'] == 'film-music-performance')
	$cat_id = get_cat_ID('Film/Music/Performance');
	if($wp_query->query_vars['category_name'] == 'architecture')
		$cat_id = get_cat_ID('Architecture and Design');
if($wp_query->query_vars['category_name'] == 'cyber')
	$cat_id = get_cat_ID('Internet and Cyber Projects');
$args = array(
	'meta_key' => 'featured',
	'meta_value'  => 'on',
	'cat' => $cat_id,
...
<div id="top3">
	...
	<?php while (have_posts()) : the_post(); ?>
		<div class=" textcolor_<?php echo $categoryparent?> suggested_post <?= $count == 2 ? "no_right_border" : "" ; ?>">
			<div id="date" style=" width:100%;"><?php the_time('l, F jS, Y') ?></div>
			<div class="title" style="height: auto; width:100%;"><a href="<?php the_permalink() ?>"><?php the_title();?></a></div>
